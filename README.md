...
Plain text lookups from the Antarctic address bar now open DuckDuckGo through the proxied page flow without mirroring the search query back into the real browser URL bar.
